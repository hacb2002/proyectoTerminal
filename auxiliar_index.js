...
class DibujoFuncion{
    ...
    obtenerCoordenadasUltimaVariable(maxAnchoVariables) {
        let coordenadas = coordenadas_elemento(this.marco);
        return [coordenadas[0] + 2 + this.variables.size * (maxAnchoVariables + 2), coordenadas[1] + 10];
    }
    obtenerMarco(){
        return this.marco;
    }
